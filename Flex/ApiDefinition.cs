...
namespace Flex
{
	...
	interface FLEXManager
	{
		...
		void RegisterSimulatorShortcutWithKey(string key, UIKeyModifierFlags modifiers, IntPtr action, string description);
	...
	interface FLEXArgumentInputView
	{
		...
		unsafe bool SupportsObjCType(IntPtr type, NSObject value);
	...
	interface FLEXArgumentInputViewFactory
	{
		...
		unsafe FLEXArgumentInputView ArgumentInputViewForTypeEncoding(IntPtr typeEncoding);
		...
		unsafe FLEXArgumentInputView ArgumentInputViewForTypeEncoding(IntPtr typeEncoding, NSObject currentValue);

		// +(BOOL)canEditFieldWithTypeEncoding:(const char *)typeEncoding currentValue:(id)currentValue;
		[Static]
		[Export("canEditFieldWithTypeEncoding:currentValue:")]
		unsafe bool CanEditFieldWithTypeEncoding(IntPtr typeEncoding, NSObject currentValue);
	}
	...
	[BaseType(typeof(NSObject))]
	interface FLEXFileBrowserFileDeleteOperationController : FLEXFileBrowserFileOperationController
	{
	}

	// @interface FLEXFileBrowserFileRenameOperationController : NSObject <FLEXFileBrowserFileOperationController>
	[BaseType(typeof(NSObject))]
	interface FLEXFileBrowserFileRenameOperationController : FLEXFileBrowserFileOperationController
	{
	}
	...
	interface FLEXIvarEditorViewController
	{
		...
		unsafe IntPtr Constructor(NSObject target, IntPtr ivar);

		// +(BOOL)canEditIvar:(Ivar)ivar currentValue:(id)value;
		[Static]
		[Export("canEditIvar:currentValue:")]
		unsafe bool CanEditIvar(IntPtr ivar, NSObject value);
	}
	...
	interface FLEXMethodCallingViewController
	{
		...
		unsafe IntPtr Constructor(NSObject target, IntPtr method);
	}
	...
	partial interface Constants
	{
		...
		IntPtr kFLEXNumberOfImplicitArgs { get; }
	...
	interface FLEXPropertyEditorViewController
	{
		...
		unsafe IntPtr Constructor(NSObject target, IntPtr property);

		// +(BOOL)canEditProperty:(objc_property_t)property currentValue:(id)value;
		[Static]
		[Export("canEditProperty:currentValue:")]
		unsafe bool CanEditProperty(IntPtr property, NSObject value);
	}
	...
	interface FLEXRuntimeUtility
	{
		...
		unsafe NSValue ValueForNumberWithObjCType(IntPtr typeEncoding, string inputString);
		...
		unsafe void EnumerateTypesInStructEncoding(IntPtr structEncoding, Action<NSString, IntPtr, NSString, nuint, nuint> typeBlock);

		// +(NSValue *)valueForPrimitivePointer:(void *)pointer objCType:(const char *)type;
		[Static]
		[Export("valueForPrimitivePointer:objCType:")]
		unsafe NSValue ValueForPrimitivePointer(IntPtr pointer, IntPtr type);
	}
	...
	interface FLEXSystemLogMessage
	{
		...
		unsafe FLEXSystemLogMessage LogMessageFromASLMessage(IntPtr aslMessage);
	...
	interface FLEXUtility
	{
		...
		void ReplaceImplementationOfSelector(Selector selector, Selector swizzledSelector, Class cls, IntPtr methodDescription, NSObject implementationBlock, NSObject undefinedBlock);
	}
